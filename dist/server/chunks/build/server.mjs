import { defineComponent, ref, inject, h, Suspense, shallowRef, resolveComponent, useSlots, computed, mergeProps, unref, withCtx, renderSlot, createBlock, createCommentVNode, openBlock, toDisplayString, createVNode, provide, toValue, watch, resolveDynamicComponent, mergeModels, useModel, createTextVNode, toRef, isRef, hasInjectionContext, shallowReactive, Fragment, getCurrentInstance, onServerPrefetch, nextTick, defineAsyncComponent, createElementBlock, cloneVNode, useSSRContext, createApp, renderList, useId, onErrorCaptured, reactive, effectScope, isReadonly, isShallow, isReactive, toRaw, withModifiers, getCurrentScope, markRaw } from 'vue';
import { s as serialize, l as parseQuery, m as defu, n as klona, o as defuFn, q as isEqual, c as createError$1, v as hasProtocol, w as isScriptProtocol, x as joinURL, y as withQuery, z as sanitizeStatusCode, A as withTrailingSlash, B as withoutTrailingSlash, C as getContext, $ as $fetch$1, D as baseURL, E as createHooks, F as executeAsync, G as toRouteMatcher, H as createRouter$1 } from '../nitro/nitro.mjs';
...
import { ssrRenderComponent, ssrRenderSlot, ssrRenderClass, ssrInterpolate, ssrRenderVNode, ssrRenderList, ssrRenderSuspense, ssrRenderStyle, ssrRenderAttrs } from 'vue/server-renderer';
...
const _routes = [
  {
    ...
    component: () => import('./index-C4kCUU_y.mjs')
  },
  {
    name: "login",
    path: "/login",
    meta: __nuxt_page_meta$5 || {},
    component: () => import('./login-DiSj1MTc.mjs')
  },
  {
    name: "register",
    path: "/register",
    meta: __nuxt_page_meta$4 || {},
    component: () => import('./register-gliDHaCj.mjs')
  },
  {
    name: "reset-password",
    path: "/reset-password",
    meta: __nuxt_page_meta$3 || {},
    component: () => import('./reset-password-N_i4417m.mjs')
  },
  {
    name: "forgot-password",
    path: "/forgot-password",
    meta: __nuxt_page_meta$2 || {},
    component: () => import('./forgot-password-2tRVtov_.mjs')
  },
  {
    name: "token-validation",
    path: "/token-validation",
    meta: __nuxt_page_meta$1 || {},
    component: () => import('./token-validation-DowhGRES.mjs')
  },
  {
    name: "email-verification",
    path: "/email-verification",
    meta: __nuxt_page_meta || {},
    component: () => import('./email-verification-BWgXQbF2.mjs')
  }
];
...
const UToaster = Object.assign(_sfc_main$5, { __name: "NuxtToaster" });
...
const __nuxt_component_2$1 = Object.assign(_sfc_main$3, { __name: "NuxtApp" });
const layouts = {
  auth: defineAsyncComponent(() => import('./auth-D4Kn-zTc.mjs').then((m) => m.default || m)),
  main: defineAsyncComponent(() => import('./main-Cl8C0dXg.mjs').then((m) => m.default || m))
};
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(ssrRenderComponent(_component_NuxtApp, null, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-Bt50-3kf.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-Bwi04M34.mjs'));
...
export { formFieldInjectionKey as A, looseToNumber as B, defineNuxtRouteMiddleware as C, __nuxt_component_2 as D, _export_sfc as _, __nuxt_component_0 as a, _sfc_main$8 as b, useAppConfig as c, usePortal as d, entry$1 as default, useFormField as e, useButtonGroup as f, useComponentIcons as g, _sfc_main$d as h, isArrayOfArray as i, _sfc_main$b as j, get as k, _sfc_main$c as l, compare as m, useToast as n, useState as o, createError as p, navigateTo as q, useRoute as r, useLocale as s, tv as t, useHead as u, formBusInjectionKey as v, formInputsInjectionKey as w, formLoadingInjectionKey as x, formOptionsInjectionKey as y, inputIdInjectionKey as z };
