...
const styles = {
  ...
  "components/nuxt-password.vue": () => import('./nuxt-password-styles.BMIsAOOs.mjs').then(interopDefault),
  "components/nuxt-password.vue?vue&type=style&index=0&lang.css": () => import('./nuxt-password-styles.Dn5g9pyj.mjs').then(interopDefault)
};
